        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <div class="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
                ...
                <div class="px-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-7" action="{{ route('register') }}" method="POST">
                        @csrf
                        <div>
                        ...
                        <button type="submit" class="w-full text-white bg-[#0F2C59] hover:bg-[#0f1e59] focus:ring-4 focus:outline-none focus:ring-[#0F2C59] font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Sign up</button>
                        <p class="text-sm text-center font-light text-gray-500 dark:text-gray-400">
                            Already have an account? <a href="{{ route('signin') }}" class="font-medium text-blue-500 hover:underline">Sign In</a>
                        </p>
                    </form>
                </div>
            </div>
